...
public:
    ...
    public:
        ...
        /// </summary>
        Irrlicht::GUI::GUIElement^ Caller;

        /// <summary>
        /// If the event has something to do with another element, it will be held here.
        /// </summary>
        Irrlicht::GUI::GUIElement^ Element;

        /// <summary>
        /// Type of GUI event.
        /// </summary>
        Irrlicht::GUI::GUIEventType Type;

    internal:

        GUIEvent(const SEvent::SGUIEvent& v)
            : Caller(Irrlicht::GUI::GUIElement::Wrap(v.Caller))
            , Element(Irrlicht::GUI::GUIElement::Wrap(v.Element))
            , Type((Irrlicht::GUI::GUIEventType)v.EventType) {}
    };
    ...
    /// </summary>
    Event(Irrlicht::GUI::GUIEventType type, Irrlicht::GUI::GUIElement^ caller, Irrlicht::GUI::GUIElement^ element);

    /// <summary>
    /// Constructs a GUI event.
    /// </summary>
    Event(Irrlicht::GUI::GUIEventType type, Irrlicht::GUI::GUIElement^ caller);
