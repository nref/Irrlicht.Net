...
Event::Event(Irrlicht::GUI::GUIEventType type, Irrlicht::GUI::GUIElement^ caller, Irrlicht::GUI::GUIElement^ element)
    : Lime::NativeValue<SEvent>(true)
{
...
Event::Event(Irrlicht::GUI::GUIEventType type, Irrlicht::GUI::GUIElement^ caller)
    : Lime::NativeValue<SEvent>(true)
{
    m_NativeValue = new SEvent();
    m_NativeValue->EventType = EET_GUI_EVENT;
