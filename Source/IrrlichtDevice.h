...
public:
    ...
    Irrlicht::Randomizer^ CreateRandomizer();
    ...
    bool PostEvent(Irrlicht::Event^ e);
    ...
    property Irrlicht::Logger^ Logger { Irrlicht::Logger^ get(); }
    property Irrlicht::OSOperator^ OSOperator { Irrlicht::OSOperator^ get(); }
    property Irrlicht::Randomizer^ Randomizer { Irrlicht::Randomizer^ get(); void set(Irrlicht::Randomizer^ value); }
    property Scene::SceneManager^ SceneManager { Scene::SceneManager^ get(); }
    property Irrlicht::Timer^ Timer { Irrlicht::Timer^ get(); }
    ...
    delegate bool EventHandler(Irrlicht::Event^ evnt);
