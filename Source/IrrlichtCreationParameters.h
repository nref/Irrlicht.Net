...
public:
    ...
    property Irrlicht::DeviceType DeviceType
    {
        Irrlicht::DeviceType get() { return (Irrlicht::DeviceType)m_NativeValue->DeviceType; }
        void set(Irrlicht::DeviceType value) { m_NativeValue->DeviceType = (E_DEVICE_TYPE)value; }
    }
