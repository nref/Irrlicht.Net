...
Irrlicht::Randomizer^ IrrlichtDevice::CreateRandomizer()
{
    irr::IRandomizer* r = m_IrrlichtDevice->createDefaultRandomizer();
    return Irrlicht::Randomizer::Wrap(r);
}
...
bool IrrlichtDevice::PostEvent(Irrlicht::Event^ e)
{
...
Irrlicht::Logger^ IrrlichtDevice::Logger::get()
{
    irr::ILogger* l = m_IrrlichtDevice->getLogger();
    return Irrlicht::Logger::Wrap(l);
}

Irrlicht::OSOperator^ IrrlichtDevice::OSOperator::get()
{
    irr::IOSOperator* o = m_IrrlichtDevice->getOSOperator();
    return Irrlicht::OSOperator::Wrap(o);
}

Irrlicht::Randomizer^ IrrlichtDevice::Randomizer::get()
{
    irr::IRandomizer* r = m_IrrlichtDevice->getRandomizer();
    return Irrlicht::Randomizer::Wrap(r);
}

void IrrlichtDevice::Randomizer::set(Irrlicht::Randomizer^ value)
{
...
Irrlicht::Timer^ IrrlichtDevice::Timer::get()
{
    irr::ITimer* t = m_IrrlichtDevice->getTimer();
    return Irrlicht::Timer::Wrap(t);
}
...
bool IrrlichtDevice::Event(Irrlicht::Event^ e)
{
    return OnEvent(e);
}
